 ...
 * cream-muted borders, square, no shadow), so it merges with the surrounding grid
 ...
 * (success). The WhatsApp crosses stay charcoal-muted (gray), per the rules.
 */
const ZERNIO = [
    ...
    <section>
      ...
      <div className="flex flex-col items-center gap-5 px-6 py-10 text-center lg:px-10">
        ...
        <h2 className="text-2xl font-bold tracking-tight text-charcoal">
          ...
          <span className="text-charcoal-muted">Ours doesn&apos;t.</span>
        </h2>
      </div>

      {/* Comparison table */}
      <div className="grid grid-cols-1 border-y border-cream-muted lg:grid-cols-2">
        {/* Zernio (first on mobile) */}
        <div className="border-cream-muted lg:border-r">
          <h3 className="px-6 py-5 text-base font-bold text-charcoal lg:px-10">
            Zernio API
          </h3>
          <ul>
            {ZERNIO.map((row) => (
              ...
              >
                <Check
                  ...
                  aria-hidden
                />
                <span className="text-base text-charcoal-muted">{row}</span>
              </li>
            ))}
          </ul>
        </div>
        ...
        {/* WhatsApp Cloud API */}
        <div className="border-t border-cream-muted lg:border-t-0">
          <h3 className="px-6 py-5 text-base font-bold text-charcoal lg:px-10">
          ...
          <ul>
            {CLOUD.map((row) => (
              ...
              >
                <X
                  className="size-6 shrink-0 text-charcoal-muted"
                  aria-hidden
                />
                <span className="text-base text-charcoal-muted">{row}</span>
              </li>
